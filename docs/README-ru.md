...
- **Kanban веб-доска** — визуализация планов в браузере с 3-уровневой навигацией
- **Agent Orchestration** — делегирование частей агентам Claude Code
- **Автоцикл --yolo** — непрерывное выполнение частей без вмешательства

...
# /plan-next — Выполнение следующей части
...
- `/plan-next ai-features` — следующая ready часть плана ai-features
- `/plan-next ai-features 03` — конкретная часть 03
- `/plan-next` — спросить какой план

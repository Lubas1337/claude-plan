...
```
Ready parts:
→ 03-api-layer (S, Agent: none, unblocks: 05, 06)
  04-workers (M, Agent: auto → tdd-guide, parallel with 03)

Варианты:
1. Выполнить 03 здесь, делегировать 04 агенту в worktree
2. Делегировать обе агентам параллельно в worktrees
3. Выполнить только 03 здесь (последовательно)
```
